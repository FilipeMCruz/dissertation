...
\begin{itemize}
    ...
    \item \nameref{par:stateofart:arch:infra:middleware:aws};
    \item \nameref{par:stateofart:arch:infra:middleware:watson};
\end{itemize}
...
This section mentions the Smart Irrigation Systems discussed by \cite{OBAIDEEN2022100124}.
