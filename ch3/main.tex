...
\begin{table}[H]
    ...
    \multirow{5}{*}{A} & Fleet Management           & On-Site & Dedicated & Private & Sensae Console     \\ \cmidrule(l){2-6}
                       & Smart Irrigation           & On-Site & Dedicated & Private & Sensae Console     \\ \cmidrule(l){2-6}
                       & Smart Parking              & On-Site & Dedicated & Private & Sensae Console     \\ \cmidrule(l){2-6}
                       & Indoor Fire Detention      & On-Site & Dedicated & Private & SMS and Email      \\ \cmidrule(l){2-6}
                       & Public Health Surveillance & On-Site & Dedicated & Public  & Sensae Console     \\ \midrule
...
\begin{itemize}
    ...
    \item Data Exposure Control: Users have control how their data is exposed to other users (UNI.002);
    \item Data Semantic Description: The system should enable the provision and exchange of semantics between services in order to support the design of new applications (UNI.003);
    \item Communication: The system built shall support event-based, periodic, and/or autonomous communication (UNI.005);
    ...
    \item Data Storage; The system shall provide historical information about the physical entity (UNI.041);
...
\begin{itemize}
    ...
    \item A system shall support time-critical message handling and delivery on a second time scale (UNI.026);
    \item When an alarm is triggered, the system should dispatch the alarm within 10 seconds in 90\% of the cases;
    \item Data shall be processed on a set of distributed nodes (UNI.234);
...
Most Identity Providers adder to the OpenID Connect Standard, therefore it's possible to develop a single solution that can exchange information with various Identity Providers in a agnostic manner.
