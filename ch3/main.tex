...
\begin{table}[H]
    ...
    \multirow{5}{*}{A} & Fleet Management           & On-Premise & Multi-Tenant & Private & Sensae Console     \\ \cmidrule(l){2-6}
                       & Smart Irrigation           & On-Premise & Multi-Tenant & Private & Sensae Console     \\ \cmidrule(l){2-6}
                       & Smart Parking              & On-Premise & Multi-Tenant & Private & Sensae Console     \\ \cmidrule(l){2-6}
                       & Indoor Fire Detention      & On-Premise & Multi-Tenant & Private & SMS and Email      \\ \cmidrule(l){2-6}
                       & Public Health Surveillance & On-Premise & Multi-Tenant & Public  & Sensae Console     \\ \midrule
    B                  & Fleet Management           & Cloud      & Multi-Tenant & Private & Org B Platform     \\ \midrule
    \multirow{3}{*}{C} & Smart Irrigation           & Cloud      & Single-Tenant    & Private & Sensae Console     \\ \cmidrule(l){2-6}
                       & Indoor Fire Detention      & Cloud      & Single-Tenant    & Private & SMS and Email      \\ \cmidrule(l){2-6}
                       & Chicken Farm Monitoring    & Cloud      & Single-Tenant    & Private & Sensae Console     \\ \midrule
    D                  & Smart Irrigation           & Cloud      & Single-Tenant    & Private & Sensae Console     \\ \bottomrule
    \end{tabular}
\end{table}
