...
\begin{itemize}
    ...
    \item A Costumer must be able to see the traveled distance of a vehicle, in a defined timespan.
\end{itemize}
...
\begin{itemize}
    ...
    \item Data Exposure Control: Users have control how their data is exposed to (shared with) other users (UNI.002);
