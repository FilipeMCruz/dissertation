...
\begin{table}[H]
    ...
    \multirow{5}{*}{A} & Fleet Management           & On-Premise & Dedicated & Private & Sensae Console     \\ \cmidrule(l){2-6} 
                       ...
                       & Indoor Fire Detention      & On-Premise & Dedicated & Private & None     \\ \cmidrule(l){2-6} 
    ...
    \multirow{3}{*}{C} & Smart Irrigation           & Cloud      & Shared    & Private & Sensae Console     \\ \cmidrule(l){2-6} 
                       & Indoor Fire Detention      & Cloud      & Shared    & Private & None     \\ \cmidrule(l){2-6} 
...
\begin{itemize}
    ...
    \item High Data Ingestion: The system must be able to successfully process, evaluate and store device data with a throughput of at least 30000 data units per minute.
\end{itemize}
