...
The Containerization and Orchestration of services via Docker and Docker Compose is discussed in Appendix~\ref{appendix:docker}.
...
As we can see this rule matches when the same device reports measures of air humidity higher than 50\% and temperature lower then 26 Celsius degrees for more than 11 minutes.
