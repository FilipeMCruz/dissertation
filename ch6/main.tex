...
According to the article \citetitle{centralreq} by \cite{centralreq}, to publish an artifact to maven central, a couple of additions have to be made in the \textit{pom.xml} of the project namely:

\begin{itemize}
    \item Supply Javadoc and Sources;
    \item Provide Files Checksums;
    \item Sign Files with GPG/PGP;
    \item Sufficient Metadata;
    \item Correct Coordinates;
    \item Project Name, Description and URL;
    \item License Information;
    \item Developer Information;
    \item SCM Information;
\end{itemize}
